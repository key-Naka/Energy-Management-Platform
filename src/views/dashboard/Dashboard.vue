    ...
    <el-row :gutter="20">
        <el-col :span="18">
            ...
            <el-card>
                ...
                <el-row>
                    <el-col :span="9">
                        <div ref="chartref" style="width: 100%;  min-height: 400px; height: auto; "></div>
                    </el-col>
                    <el-col :span="15">
                        <div ref="chartref2" style="width: 100%; min-height: 400px; height: auto;"> </div>
                    </el-col>
                </el-row>
            </el-card>
        </el-col>
...
import { useCharts } from "@/hooks/useChats"
import { ref, reactive } from 'vue';
import { getChartDataApi, chartDataApi, chartDataApi3 } from '@/api/dashboard'
...
const setChartData2 = async () => {
    ...
    chartOptions.legend.data = res.data.list.map((item: { name: any }) => item.name)
