<template>
  <el-tabs :model-value="currentTap.name" type="card" class="demo-tabs" closable @tab-click="handleClick"
    @tab-remove="remove">
    <el-tab-pane v-for="item in taps" :key="item.url" :lable="item.name" :name="item.name">
      <template #label>
